...
**Phase:** **Etappe v10 (E-C Text-Writer Sub-1 = CoverLetterWriter, Marek) ABGESCHLOSSEN+COMMITTED** — deterministischer (Gating-Default, keine API) JD-getriebener Anschreiben-Generator; besteht critic+factground-Gate 0 FEHLER; 28/28 grün. **NÄCHSTE Etappe = E-C Text-Writer Sub-2 = CVTailoring** (CV-Bullets nach Anzeigen-Keywords umsortieren/gewichten). Brief unten im Sofort-Einstieg.
**Ziel-Session:** Claude Code CLI (nächste Etappe = E-C Text-Writer Sub-2 CVTailoring / Marek)
